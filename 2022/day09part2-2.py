    ...
    def update(self, inst) -> None:
        ...
        for knot in self.rope.knots:
            ...
            try:
                ...
                # sometimes it just goes way out of bounds and i'm too tired
                # and bored to account for that now so just reset to the origin.
                self.points[self.origin_y][self.origin_x] = knot.get_sprite()
